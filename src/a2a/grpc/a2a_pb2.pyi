...
class AgentCard(_message.Message):
    __slots__ = ("protocol_version", "name", "description", "supported_interfaces", "provider", "version", "documentation_url", "capabilities", "security_schemes", "security", "default_input_modes", "default_output_modes", "skills", "supports_extended_agent_card", "signatures", "icon_url")

...
from a2a.compat.v0_3.conversions import (
    to_core_part, to_compat_part, 
    to_core_message, to_compat_message, 
    to_core_task_status, to_compat_task_status, 
    to_core_task, to_compat_task
)
...
def test_text_part_conversion():
    ...
    ParseDict({"test": "val"}, v10_expected.metadata)
...
def test_data_part_conversion():
    data_content = {"key": "value", "number": 42}
    v03_part = types_v03.Part(root=types_v03.DataPart(data=data_content))
    v10_expected = pb2_v10.Part()
    ParseDict(data_content, v10_expected.data.struct_value)
...
def test_data_part_conversion_with_metadata():
    data_content = {"key": "value"}
    metadata = {"meta": "data"}
    v03_part = types_v03.Part(root=types_v03.DataPart(data=data_content, metadata=metadata))
    
    v10_expected = pb2_v10.Part()
    ParseDict(data_content, v10_expected.data.struct_value)
    ParseDict(metadata, v10_expected.metadata)
...
def test_file_with_bytes_conversion_full():
    raw_bytes = b"test"
    v03_part = types_v03.Part(
        root=types_v03.FilePart(
            file=types_v03.FileWithBytes(bytes=base64.b64encode(raw_bytes).decode('utf-8'), name="n", mime_type="m"),
            metadata={"f": "m"}
        )
    )
    v10_expected = pb2_v10.Part(
    ...
    ParseDict({"f": "m"}, v10_expected.metadata)
    ...
    v03_min = types_v03.Part(root=types_v03.FilePart(file=types_v03.FileWithBytes(bytes="dGVzdA==")))
    v10_expected_min = pb2_v10.Part(raw=b"test")
    v10_min = to_core_part(v03_min)
    assert v10_min == v10_expected_min
    assert to_compat_part(v10_min) == v03_min

def test_file_with_uri_conversion_full():
    v03_part = types_v03.Part(
        root=types_v03.FilePart(
            file=types_v03.FileWithUri(uri="u", name="n", mime_type="m"),
            metadata={"f": "m"}
        )
    )
    v10_expected = pb2_v10.Part(
    ...
    v03_min = types_v03.Part(root=types_v03.FilePart(file=types_v03.FileWithUri(uri="u")))
    v10_expected_min = pb2_v10.Part(url="u")
    v10_min = to_core_part(v03_min)
    assert v10_min == v10_expected_min
    assert to_compat_part(v10_min) == v03_min

def test_unknown_part_type():
    v10_part = pb2_v10.Part() # No content set
    with pytest.raises(ValueError, match="Unknown part content type"):
        to_compat_part(v10_part)

def test_message_conversion():
    v03_msg = types_v03.Message(
        message_id="m1", context_id="c1", task_id="t1",
        role=types_v03.Role.user, reference_task_ids=["r1"],
        parts=[types_v03.Part(root=types_v03.TextPart(text="Hi"))]
    )
    v10_expected = pb2_v10.Message(
        message_id="m1", context_id="c1", task_id="t1",
        role=pb2_v10.Role.ROLE_USER, reference_task_ids=["r1"],
...
def test_message_conversion_agent():
    v03_msg = types_v03.Message(
        message_id="m1", role=types_v03.Role.agent,
        parts=[types_v03.Part(root=types_v03.TextPart(text="Hello"))]
    )
    v10_expected = pb2_v10.Message(
        message_id="m1", role=pb2_v10.Role.ROLE_AGENT,
        parts=[pb2_v10.Part(text="Hello")]
    )
...
def test_message_role_unspecified():
    v03_msg = types_v03.Message(message_id="m1", role=types_v03.Role.user, parts=[])
    v03_msg.role = None # type: ignore
    
    v10_expected = pb2_v10.Message(
        message_id="m1", role=pb2_v10.Role.ROLE_UNSPECIFIED
    )
    v10_msg = to_core_message(v03_msg)
    assert v10_msg == v10_expected
    
    v03_restored = to_compat_message(v10_msg)
    v03_expected_restored = types_v03.Message(message_id="m1", role=types_v03.Role.agent, parts=[])
    assert v03_restored == v03_expected_restored

def test_task_status_conversion():
    v03_status = types_v03.TaskStatus(
        state=types_v03.TaskState.completed,
        message=types_v03.Message(
            message_id="m2", role=types_v03.Role.agent,
            parts=[types_v03.Part(root=types_v03.TextPart(text="Done"))]
        ),
        timestamp="2023-01-01T12:00:00Z"
    )
    v10_expected = pb2_v10.TaskStatus(
        state=pb2_v10.TaskState.TASK_STATE_COMPLETED,
        message=pb2_v10.Message(
            message_id="m2", role=pb2_v10.Role.ROLE_AGENT,
            parts=[pb2_v10.Part(text="Done")]
        )
    )
    v10_expected.timestamp.FromJsonString("2023-01-01T12:00:00Z")
...
def test_task_status_no_state():
    v03_status = types_v03.TaskStatus(state=types_v03.TaskState.working)
    v03_status.state = None # type: ignore
    
    v10_expected = pb2_v10.TaskStatus(state=pb2_v10.TaskState.TASK_STATE_UNSPECIFIED)
    v10_status = to_core_task_status(v03_status)
    assert v10_status == v10_expected
    
    v03_restored = to_compat_task_status(v10_status)
    v03_expected_restored = types_v03.TaskStatus(state=types_v03.TaskState.unknown)
    assert v03_restored == v03_expected_restored

def test_task_status_unknown_state():
    v03_status = types_v03.TaskStatus(state=types_v03.TaskState.unknown)
...
def test_task_status_none_state():
    v03_status = types_v03.TaskStatus(state=types_v03.TaskState.working)
    v03_status.state = None # type: ignore
...
def test_task_conversion_full():
    v03_task = types_v03.Task(
        id="t1", context_id="c1",
        status=types_v03.TaskStatus(state=types_v03.TaskState.working),
        history=[
            types_v03.Message(
                message_id="m1", role=types_v03.Role.user,
                parts=[types_v03.Part(root=types_v03.TextPart(text="Do this"))]
            )
        ]
    )
    v10_expected = pb2_v10.Task(
        id="t1", context_id="c1",
        status=pb2_v10.TaskStatus(state=pb2_v10.TaskState.TASK_STATE_WORKING),
        history=[
            pb2_v10.Message(
                message_id="m1", role=pb2_v10.Role.ROLE_USER,
                parts=[pb2_v10.Part(text="Do this")]
            )
        ]
    )
    ...
    assert v03_restored == v03_task

def test_task_conversion_no_status_no_history():
    v03_task = types_v03.Task(
        id="t", context_id="c", 
        status=types_v03.TaskStatus(state=types_v03.TaskState.working),
        history=None
    )
    v03_task.status = None # type: ignore
    
    v10_expected = pb2_v10.Task(id="t", context_id="c")
    v10_task = to_core_task(v03_task)
    assert v10_task == v10_expected
...
from a2a.compat.v0_3.conversions import (
    to_core_authentication_info, to_compat_authentication_info,
    to_core_push_notification_config, to_compat_push_notification_config,
    to_core_send_message_configuration, to_compat_send_message_configuration
)
...
def test_authentication_info_conversion_minimal():
    ...
    v03_restored = to_compat_authentication_info(v10_auth)
    v03_expected_restored = types_v03.PushNotificationAuthenticationInfo(schemes=[], credentials=None)
    assert v03_restored == v03_expected_restored
...
def test_push_notification_config_conversion():
    ...
    v03_config = types_v03.PushNotificationConfig(
        id="c1", url="http://test.com", token="tok", authentication=v03_auth
    )
    
    v10_expected = pb2_v10.PushNotificationConfig(
        id="c1", url="http://test.com", token="tok",
...
def test_send_message_configuration_conversion():
    v03_auth = types_v03.PushNotificationAuthenticationInfo(schemes=["Basic"])
    v03_push = types_v03.PushNotificationConfig(url="http://test", authentication=v03_auth)
...
def test_send_message_configuration_conversion_minimal():
    ...
    v03_expected_restored = types_v03.MessageSendConfiguration(
        accepted_output_modes=None, history_length=None, blocking=True, push_notification_config=None
    )
    assert v03_restored == v03_expected_restored

from a2a.compat.v0_3.conversions import (
    to_core_artifact, to_compat_artifact,
    to_core_task_status_update_event, to_compat_task_status_update_event,
    to_core_task_artifact_update_event, to_compat_task_artifact_update_event
)
...
def test_artifact_conversion_minimal():
    ...
    v03_expected_restored = types_v03.Artifact(
        artifact_id="a1",
        parts=[types_v03.Part(root=types_v03.TextPart(text="data"))],
        name=None, description=None, metadata=None, extensions=None
    )
    assert v03_restored == v03_expected_restored
...
def test_task_artifact_update_event_conversion():
    v03_art = types_v03.Artifact(
        artifact_id="a1", parts=[types_v03.Part(root=types_v03.TextPart(text="d"))]
    )
...
from a2a.compat.v0_3.conversions import (
    to_core_security_requirement, to_compat_security_requirement,
    to_core_oauth_flows, to_compat_oauth_flows,
    to_core_security_scheme, to_compat_security_scheme
)
...
def test_oauth_flows_conversion_auth_code():
    v03_flows = types_v03.OAuthFlows(
        authorization_code=types_v03.AuthorizationCodeOAuthFlow(
            authorization_url="http://auth", token_url="http://token", scopes={"a": "b"}, refresh_url="ref1"
        )
    )
...
def test_oauth_flows_conversion_client_credentials():
    v03_flows = types_v03.OAuthFlows(
        client_credentials=types_v03.ClientCredentialsOAuthFlow(
            token_url="http://token2", scopes={"c": "d"}, refresh_url="ref2"
        )
    )
    v10_expected = pb2_v10.OAuthFlows(
...
def test_oauth_flows_conversion_implicit():
    v03_flows = types_v03.OAuthFlows(
        implicit=types_v03.ImplicitOAuthFlow(
            authorization_url="http://auth2", scopes={"e": "f"}, refresh_url="ref3"
        )
    )
    v10_expected = pb2_v10.OAuthFlows(
...
def test_oauth_flows_conversion_password():
    v03_flows = types_v03.OAuthFlows(
        password=types_v03.PasswordOAuthFlow(
            token_url="http://token3", scopes={"g": "h"}, refresh_url="ref4"
        )
    )
    v10_expected = pb2_v10.OAuthFlows(
...
def test_security_scheme_apikey():
    v03_scheme = types_v03.SecurityScheme(root=types_v03.APIKeySecurityScheme(
...
def test_security_scheme_http_auth():
    v03_scheme = types_v03.SecurityScheme(root=types_v03.HTTPAuthSecurityScheme(
...
def test_security_scheme_oauth2():
    v03_flows = types_v03.OAuthFlows(
        authorization_code=types_v03.AuthorizationCodeOAuthFlow(
            authorization_url="u", token_url="t", scopes={}
        )
    )
    v03_scheme = types_v03.SecurityScheme(root=types_v03.OAuth2SecurityScheme(
    ...
    v10_expected = pb2_v10.SecurityScheme(
        oauth2_security_scheme=pb2_v10.OAuth2SecurityScheme(
            flows=pb2_v10.OAuthFlows(
                authorization_code=pb2_v10.AuthorizationCodeOAuthFlow(
                    authorization_url="u", token_url="t"
                )
            ),
            oauth2_metadata_url="url", description="desc"
        )
    )
    v10_scheme = to_core_security_scheme(v03_scheme)
    assert v10_scheme == v10_expected
...
def test_security_scheme_oidc():
    v03_scheme = types_v03.SecurityScheme(root=types_v03.OpenIdConnectSecurityScheme(
...
def test_security_scheme_mtls():
    v03_scheme = types_v03.SecurityScheme(root=types_v03.MutualTLSSecurityScheme(
        description="desc"
    ))
    v10_expected = pb2_v10.SecurityScheme(
...
def test_oauth_flows_conversion_minimal():
    v03_flows = types_v03.OAuthFlows(
        authorization_code=types_v03.AuthorizationCodeOAuthFlow(
            authorization_url="http://auth", token_url="http://token", scopes={"a": "b"}
        ) # no refresh_url
    )
    v10_expected = pb2_v10.OAuthFlows(
        authorization_code=pb2_v10.AuthorizationCodeOAuthFlow(
...
from a2a.compat.v0_3.conversions import (
    to_core_agent_interface, to_compat_agent_interface,
    to_core_agent_provider, to_compat_agent_provider,
    to_core_agent_extension, to_compat_agent_extension,
    to_core_agent_capabilities, to_compat_agent_capabilities,
    to_core_agent_skill, to_compat_agent_skill,
    to_core_agent_card_signature, to_compat_agent_card_signature,
    to_core_agent_card, to_compat_agent_card
)

def test_agent_interface_conversion():
    v03_int = types_v03.AgentInterface(url="http", transport="JSONRPC")
    v10_expected = pb2_v10.AgentInterface(url="http", protocol_binding="JSONRPC", protocol_version="0.3.0")
...
def test_agent_extension_conversion():
    v03_ext = types_v03.AgentExtension(uri="u", description="d", required=True, params={"k": "v"})
    v10_expected = pb2_v10.AgentExtension(uri="u", description="d", required=True)
...
def test_agent_capabilities_conversion():
    ...
    v03_cap = types_v03.AgentCapabilities(
        streaming=True, push_notifications=False, extensions=[v03_ext], state_transition_history=True
    )
    v10_expected = pb2_v10.AgentCapabilities(
        streaming=True, push_notifications=False, extensions=[pb2_v10.AgentExtension(uri="u", required=False)]
    )
    ...
    v03_expected_restored = types_v03.AgentCapabilities(
        streaming=True, push_notifications=False, extensions=[v03_ext], state_transition_history=None
    )
    assert v03_restored == v03_expected_restored

def test_agent_skill_conversion():
    v03_skill = types_v03.AgentSkill(
        id="s1", name="n", description="d", tags=["t"], examples=["e"],
        input_modes=["i"], output_modes=["o"], security=[{"s": ["1"]}]
    )
    v10_expected = pb2_v10.AgentSkill(
        id="s1", name="n", description="d", tags=["t"], examples=["e"],
        input_modes=["i"], output_modes=["o"]
    )
...
def test_agent_card_signature_conversion():
    v03_sig = types_v03.AgentCardSignature(protected="p", signature="s", header={"h": "v"})
...
def test_agent_card_conversion():
    ...
    v03_skill = types_v03.AgentSkill(id="s1", name="sn", description="sd", tags=[], input_modes=[], output_modes=[])
    v03_prov = types_v03.AgentProvider(url="pu", organization="po")
    
    v03_card = types_v03.AgentCard(
        name="n", description="d", version="v", url="u1", preferred_transport="JSONRPC", protocol_version="0.3.0",
        additional_interfaces=[v03_int], provider=v03_prov, documentation_url="du", icon_url="iu",
        capabilities=v03_cap, supports_authenticated_extended_card=True,
        security=[{"s": []}], default_input_modes=["i"], default_output_modes=["o"],
        skills=[v03_skill]
    )
    
    v10_expected = pb2_v10.AgentCard(
        name="n", description="d", version="v", documentation_url="du", icon_url="iu",
        default_input_modes=["i"], default_output_modes=["o"]
    )
    v10_expected.supported_interfaces.extend([
        pb2_v10.AgentInterface(url="u1", protocol_binding="JSONRPC", protocol_version="0.3.0"),
        pb2_v10.AgentInterface(url="u2", protocol_binding="HTTP", protocol_version="0.3.0")
    ])
    v10_expected.provider.CopyFrom(pb2_v10.AgentProvider(url="pu", organization="po"))
    v10_expected.capabilities.CopyFrom(pb2_v10.AgentCapabilities(streaming=True, extended_agent_card=True))
    v10_expected.security_requirements.add().schemes["s"].CopyFrom(pb2_v10.StringList())
    v10_expected.skills.add().CopyFrom(pb2_v10.AgentSkill(id="s1", name="sn", description="sd"))
...
def test_agent_card_conversion_minimal():
    ...
    v03_card = types_v03.AgentCard(
        name="n", description="d", version="v", url="u1", preferred_transport="JSONRPC", protocol_version="0.3.0",
        capabilities=v03_cap, default_input_modes=[], default_output_modes=[], skills=[]
    )
    v10_expected = pb2_v10.AgentCard(
        name="n", description="d", version="v", capabilities=pb2_v10.AgentCapabilities()
    )
    v10_expected.supported_interfaces.extend([
        pb2_v10.AgentInterface(url="u1", protocol_binding="JSONRPC", protocol_version="0.3.0")
    ])
...
def test_agent_skill_conversion_minimal():
    v03_skill = types_v03.AgentSkill(id="s1", name="n", description="d", tags=[], input_modes=[], output_modes=[])
    ...
    v03_expected_restored = types_v03.AgentSkill(
        id="s1", name="n", description="d", tags=[],
        examples=None, input_modes=None, output_modes=None, security=None
    )
    assert v03_restored == v03_expected_restored
...
def test_agent_extension_conversion_minimal():
    ...
    assert v10_ext == v10_expected
    v03_restored = to_compat_agent_extension(v10_ext)
    v03_expected_restored = types_v03.AgentExtension(uri="u", description=None, required=False, params=None)
    assert v03_restored == v03_expected_restored

from a2a.compat.v0_3.conversions import (
    to_core_task_push_notification_config, to_compat_task_push_notification_config,
    to_core_send_message_request, to_compat_send_message_request,
    to_core_get_task_request, to_compat_get_task_request,
    to_core_cancel_task_request, to_compat_cancel_task_request
)
...
def test_task_push_notification_config_conversion():
    ...
    v03_cfg = types_v03.TaskPushNotificationConfig(
        ...
        push_notification_config=types_v03.PushNotificationConfig(
            id="c1", url="http://url", token="tok", authentication=v03_auth
        )
    )
    v10_expected = pb2_v10.TaskPushNotificationConfig(
        task_id="t1",
        push_notification_config=pb2_v10.PushNotificationConfig(
            id="c1", url="http://url", token="tok",
            authentication=pb2_v10.AuthenticationInfo(scheme="Basic")
        )
    )
...
def test_task_push_notification_config_conversion_minimal():
    v03_cfg = types_v03.TaskPushNotificationConfig(
        task_id="t1", push_notification_config=types_v03.PushNotificationConfig(url="http://url")
    )
    v10_expected = pb2_v10.TaskPushNotificationConfig(
        task_id="t1", push_notification_config=pb2_v10.PushNotificationConfig(url="http://url")
    )
    v10_cfg = to_core_task_push_notification_config(v03_cfg)
    assert v10_cfg == v10_expected
    v03_restored = to_compat_task_push_notification_config(v10_cfg)
...
def test_send_message_request_conversion():
    v03_msg = types_v03.Message(message_id="m1", role=types_v03.Role.user, parts=[types_v03.Part(root=types_v03.TextPart(text="Hi"))])
    v03_cfg = types_v03.MessageSendConfiguration(history_length=5)
    v03_req = types_v03.SendMessageRequest(
        id="conv",
        params=types_v03.MessageSendParams(message=v03_msg, configuration=v03_cfg, metadata={"k": "v"})
    )
    v10_expected = pb2_v10.SendMessageRequest(
        message=pb2_v10.Message(message_id="m1", role=pb2_v10.Role.ROLE_USER, parts=[pb2_v10.Part(text="Hi")]),
        configuration=pb2_v10.SendMessageConfiguration(history_length=5, blocking=True)
    )
    ParseDict({"k": "v"}, v10_expected.metadata)
    
    v10_req = to_core_send_message_request(v03_req)
    assert v10_req == v10_expected
    v03_restored = to_compat_send_message_request(v10_req)
...
def test_get_task_request_conversion():
    v03_req = types_v03.GetTaskRequest(id="conv", params=types_v03.TaskQueryParams(id="t1", history_length=10))
    v10_expected = pb2_v10.GetTaskRequest(id="t1", history_length=10)
    v10_req = to_core_get_task_request(v03_req)
    assert v10_req == v10_expected
    v03_restored = to_compat_get_task_request(v10_req)
    assert v03_restored == v03_req

def test_get_task_request_conversion_minimal():
    v03_req = types_v03.GetTaskRequest(id="conv", params=types_v03.TaskQueryParams(id="t1"))
...
def test_cancel_task_request_conversion():
    v03_req = types_v03.CancelTaskRequest(id="conv", params=types_v03.TaskIdParams(id="t1", metadata={"reason": "test"}))
    ...
    assert v10_req == v10_expected
    v03_restored = to_compat_cancel_task_request(v10_req)
    assert v03_restored == v03_req

def test_cancel_task_request_conversion_minimal():
    v03_req = types_v03.CancelTaskRequest(id="conv", params=types_v03.TaskIdParams(id="t1"))
    v10_expected = pb2_v10.CancelTaskRequest(id="t1")
    v10_req = to_core_cancel_task_request(v03_req)
    assert v10_req == v10_expected
    v03_restored = to_compat_cancel_task_request(v10_req)
...
from a2a.compat.v0_3.conversions import (
    to_core_get_task_push_notification_config_request, to_compat_get_task_push_notification_config_request,
    to_core_delete_task_push_notification_config_request, to_compat_delete_task_push_notification_config_request,
    to_core_create_task_push_notification_config_request, to_compat_create_task_push_notification_config_request,
    to_core_subscribe_to_task_request, to_compat_subscribe_to_task_request,
    to_core_list_task_push_notification_config_request, to_compat_list_task_push_notification_config_request,
    to_core_list_task_push_notification_config_response, to_compat_list_task_push_notification_config_response,
    to_core_send_message_response, to_compat_send_message_response,
    to_core_stream_response, to_compat_stream_response
)

def test_create_task_push_notification_config_request_conversion():
    v03_cfg = types_v03.TaskPushNotificationConfig(
        task_id="t1", push_notification_config=types_v03.PushNotificationConfig(url="u")
    )
    ...
    assert v10_req == v10_expected
    v03_restored = to_compat_create_task_push_notification_config_request(v10_req)
    assert v03_restored == v03_req
...
def test_get_task_push_notification_config_request_conversion():
    ...
    assert v10_req == v10_expected
    v03_restored = to_compat_get_task_push_notification_config_request(v10_req)
    assert v03_restored == v03_req
...
def test_delete_task_push_notification_config_request_conversion():
    v03_req = types_v03.DeleteTaskPushNotificationConfigRequest(
        id="conv", params=types_v03.DeleteTaskPushNotificationConfigParams(id="t1", push_notification_config_id="p1")
    )
    v10_expected = pb2_v10.DeleteTaskPushNotificationConfigRequest(task_id="t1", id="p1")
    v10_req = to_core_delete_task_push_notification_config_request(v03_req)
    assert v10_req == v10_expected
    v03_restored = to_compat_delete_task_push_notification_config_request(v10_req)
    assert v03_restored == v03_req
...
def test_subscribe_to_task_request_conversion():
    ...
    assert v10_req == v10_expected
    v03_restored = to_compat_subscribe_to_task_request(v10_req)
    assert v03_restored == v03_req

def test_list_task_push_notification_config_request_conversion():
    v03_req = types_v03.ListTaskPushNotificationConfigRequest(
        id="conv", params=types_v03.ListTaskPushNotificationConfigParams(id="t1")
    )
    ...
    assert v10_req == v10_expected
    v03_restored = to_compat_list_task_push_notification_config_request(v10_req)
    assert v03_restored == v03_req
...
def test_list_task_push_notification_config_response_conversion():
    ...
    v03_res = types_v03.ListTaskPushNotificationConfigResponse(
        root=types_v03.ListTaskPushNotificationConfigSuccessResponse(result=[v03_cfg])
    )
    v10_expected = pb2_v10.ListTaskPushNotificationConfigsResponse(
        configs=[pb2_v10.TaskPushNotificationConfig(task_id="t1", push_notification_config=pb2_v10.PushNotificationConfig(url="u"))]
    )
    v10_res = to_core_list_task_push_notification_config_response(v03_res)
    assert v10_res == v10_expected
    v03_restored = to_compat_list_task_push_notification_config_response(v10_res)
    assert v03_restored == v03_res

def test_send_message_response_conversion():
    v03_task = types_v03.Task(id="t1", context_id="c1", status=types_v03.TaskStatus(state=types_v03.TaskState.unknown))
    v03_res = types_v03.SendMessageResponse(
        root=types_v03.SendMessageSuccessResponse(result=v03_task)
    )
    v10_expected = pb2_v10.SendMessageResponse(
        task=pb2_v10.Task(id="t1", context_id="c1", status=pb2_v10.TaskStatus(state=pb2_v10.TaskState.TASK_STATE_UNSPECIFIED))
    )
    v10_res = to_core_send_message_response(v03_res)
    assert v10_res == v10_expected
    v03_restored = to_compat_send_message_response(v10_res)
    assert v03_restored == v03_res

from a2a.compat.v0_3.conversions import to_core_get_extended_agent_card_request, to_compat_get_extended_agent_card_request
...
def test_get_extended_agent_card_request_conversion():
    ...
    assert v10_req == v10_expected
    v03_restored = to_compat_get_extended_agent_card_request(v10_req)
    assert v03_restored == v03_req

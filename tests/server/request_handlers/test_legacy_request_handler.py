...
async def test_on_cancel_task_queue_tap_returns_none():
    ...
    context = create_server_call_context()
    with patch(
        'a2a.server.request_handlers.legacy_request_handler.ResultAggregator',
...
async def test_on_message_send_with_push_notification():
    ...
    with (
        ...
        patch(
            'a2a.server.request_handlers.legacy_request_handler.TaskManager.get_task',
            return_value=sample_initial_task,
        ),
        patch(
            'a2a.server.request_handlers.legacy_request_handler.TaskManager.update_with_message',
            return_value=sample_initial_task,
        ),
...
@pytest.mark.asyncio
async def test_on_message_send_stream_with_push_notification():  # noqa: PLR0915
...
@pytest.mark.asyncio
async def test_on_message_send_stream_client_disconnect_triggers_background_cleanup_and_producer_continues():  # noqa: PLR0915
...
@pytest.mark.asyncio
async def test_background_cleanup_task_is_tracked_and_cleared():  # noqa: PLR0915
